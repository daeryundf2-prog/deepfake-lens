...
> **진행 상태 (2026-09-15)**: V1-1 ✅ V1-2 ✅ V1-3 ✅ V2-1 ✅ V2-2 ✅ V3 ✅ V4 ✅ V5-1 ✅ V5-2 ✅ V5-3 ✅ — V6(연구 후보)만 잔여. V2-3(문서 메타데이터의 forensic 레코드화)는 `_apply_document_metadata`의 source_guess 연동으로 부분 충족.

...
> **진행 상태 (2026-09-15)**: V1-1 ✅ V1-2 ✅ V1-3 ✅ V2-1 ✅ V2-2 ✅ V3 ✅ V4 ✅ V5-1 ✅ V5-2 ✅ V5-3 ✅ — V6-1(립싱크 휴리스틱) ✅ V6-2(KGW 워터마크 검출기) ✅ V6-3(화자 대조) ✅ V6-4(stylometry 저자 대조) ✅ — V6-5(SynthID·조명물리)는 외부 자산 필요로 잔여. V2-3(문서 메타데이터의 forensic 레코드화)는 `_apply_document_metadata`의 source_guess 연동으로 부분 충족.

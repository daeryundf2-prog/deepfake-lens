...
>   feedback basis-point normalization simplification.
...
>   validation (no device connected), 3-3 full benchmark (Synthbuster
>   11.8 GB zip download in progress ~2.3 GB at last check — network-bound;
>   RAISE-1k needs a manual license form).
